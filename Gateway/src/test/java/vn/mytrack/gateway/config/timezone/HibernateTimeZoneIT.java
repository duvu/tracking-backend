package vn.mytrack.gateway.config.timezone;

import vn.mytrack.gateway.GatewayApp;
import vn.mytrack.gateway.config.SecurityBeanOverrideConfiguration;
import vn.mytrack.gateway.repository.timezone.DateTimeWrapper;
import vn.mytrack.gateway.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM trak_date_time_wrapper where id=%d", fieldName, id);
    }
