package vn.mytrack.uaa.web.rest;

import vn.mytrack.uaa.UaaApp;
import vn.mytrack.uaa.config.Constants;
import vn.mytrack.uaa.domain.User;
import vn.mytrack.uaa.repository.AuthorityRepository;
import vn.mytrack.uaa.repository.UserRepository;
import vn.mytrack.uaa.security.AuthoritiesConstants;
import vn.mytrack.uaa.service.UserService;
import vn.mytrack.uaa.service.dto.PasswordChangeDTO;
import vn.mytrack.uaa.service.dto.UserDTO;
import vn.mytrack.uaa.web.rest.vm.KeyAndPasswordVM;
import vn.mytrack.uaa.web.rest.vm.ManagedUserVM;
...
import static vn.mytrack.uaa.web.rest.AccountResourceIT.TEST_USER_LOGIN;
