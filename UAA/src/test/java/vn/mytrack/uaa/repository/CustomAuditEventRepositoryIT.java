package vn.mytrack.uaa.repository;

import vn.mytrack.uaa.UaaApp;

import vn.mytrack.uaa.config.Constants;
import vn.mytrack.uaa.config.audit.AuditEventConverter;
import vn.mytrack.uaa.domain.PersistentAuditEvent;
...
import static vn.mytrack.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
